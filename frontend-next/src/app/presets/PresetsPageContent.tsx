...
export function PresetsPageContent() {
  ...
  const [selectedPreset, setSelectedPreset] = useState<TimezonePreset | null>(
    null
  );
  ...
  const getTimezoneName = (identifier: string) => {
    ...
    return (
      tz?.displayName ||
      identifier.split('/').pop()?.replace(/_/g, ' ') ||
      identifier
    );
  };
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-center mb-4">
              Create your first preset to quickly load your favorite timezone
              combinations
            </p>
                    ...
                    .map((tz) => {
                      ...
                      return (
                        <Badge key={tz.id} variant="secondary" className="text-xs">
                          ...
                          {hours && (
                            <span className="ml-1 opacity-70">({hours})</span>
                          )}
                        </Badge>
                      );
                    })}
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <Input
                          ...
                          value={tz.endTime || ''}
                          onChange={(e) =>
                            updateTimezoneHours(index, 'endTime', e.target.value)
                          }
                          className="h-8 w-24"
                        />
                      </div>
